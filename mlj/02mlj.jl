...
# ╔═╡ 95fed049-16ec-4ad5-b2e4-a361848cfcda
...
# ╔═╡ 368bc232-79e1-4a73-b1a7-1633607d6492
...
eres = evaluate(rfm, X, y, resampling=CV(nfolds=5), measure=[auc,LogLoss()])

# ╔═╡ 5eeb8a81-1461-49f0-994f-9eb965861859
eres.per_observation
...
# ╔═╡ 71939268-f13b-40a2-b467-131bf876ffc3
mean(eres.per_fold[2])

# ╔═╡ f581796b-58e5-4955-b337-53f2f9b3116c
eres.per_fold[2]

# ╔═╡ a3167f7a-374d-4a87-989f-deab4f1302e6
1.96*std(eres.per_fold[2])/sqrt(5-1)
...
# ╔═╡ bf3a714c-2e1d-4bed-ac9f-d5f1a19b1046
NetworkComposite
