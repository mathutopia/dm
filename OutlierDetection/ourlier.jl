...
# ╔═╡ dcc213ac-6c64-4ca5-9aa1-9aa304f27050
using CSV, DataFrames, MLJ

# ╔═╡ 2d67a05b-52db-4d41-99f1-c0e7cd92b3cb
using Plots
...
# ╔═╡ 595515f6-107b-44b0-af07-ef5a0cafcba3
md"""
假设模型用这个模型，  name
"KNNDetector"
package_name
"OutlierDetectionNeighbors",  可以看到该模型的输入数据类型要求是：input_scitype = 
...
md"""
## 构建预处理模型
这个模型用于将数据从训练集直接准备成连续型数据。 1. 选择特征； 2. 类型转换； 3. 连续编码。
"""
...
# ╔═╡ 4db0b1cc-66e2-4a5e-a882-fffd6588907d
md"""
下面引入Plots包绘图， 这个包需要依赖比较多， 如果你装不成功， 可以用以前的包来画图。 我用这个是因为这个比较方便。
"""
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "5bfa54be4766f9fdf97d85076988f3224286ce45"
