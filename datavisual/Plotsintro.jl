...
# ╔═╡ 9f1c3753-8647-4790-8516-5d884e4147dd
using Plots

# ╔═╡ e8bb462c-ef73-49d0-9185-ec86d0ff9a1d
using PlutoUI

# ╔═╡ 638514a8-42f0-4789-ba0c-d259039acd59
using StatsPlots, DataFrames

# ╔═╡ 47818974-6eac-4730-bbff-5d0419ad04f4
using CSV

# ╔═╡ 8327ff59-3f87-4c4f-a681-a27e87529ede
using CairoMakie,AlgebraOfGraph

# ╔═╡ bcb40bcc-9e45-416d-a672-8d9f90719833
TableOfContents(title = "目录")

# ╔═╡ 9e90b8d3-f147-467e-b3e3-e862f0cd2d5d
plotly()

# ╔═╡ a11cfbfa-3fcb-494d-8cd7-863655ee1536
md"""
# 数据可视化
...
# ╔═╡ 1c0f7156-2c9d-40c2-8817-c9783ef7a998
plot()

# ╔═╡ c34cb90c-826f-4b50-a9f3-5b0758719834
plot(1:10)

# ╔═╡ ead0d4e1-dad0-42ba-9297-8670e6b11900
md"""
## 输入数据
一般情况下，  
- 给定一个数据源， plot(y): 会将这个数据源解释为y值， 然后自动生成x值去绘图。
...
# ╔═╡ b3f7ae1b-cf2f-4a02-8092-1b41e1fbc6c3
plot(8:17,rand(10,4))

# ╔═╡ 34e6e346-d45b-41cf-89c2-844b6228ec76
rand(10,4)

# ╔═╡ b76dc88c-30bf-4174-8143-6ac830be8b29
plot(rand(10,4), markershape = [:circle :rect])

# ╔═╡ 75306a65-f2b3-4483-b8f2-5f00b1ec37cc
[:circle :rect]

# ╔═╡ 89feb316-df59-4879-8ea3-4236691d6ead
[:circle, :rect]

# ╔═╡ eef29611-b5dc-421c-b932-88b15325d99d
begin
...
# ╔═╡ 98c1793a-6361-4416-a192-5afeb2d4baf6
md"""
...
# ╔═╡ 2ce7006a-10d5-4549-b730-c3949b87a40b
begin
x = 0:1:2pi
y = sin.(x)
end;

# ╔═╡ 90b221fa-697f-41d7-b82c-405566387726
md"""
...
# ╔═╡ 389a9a44-d39d-47bc-a25b-51505ebbe6b2
plot(y, seriestype = seriestype, linestyle = linestyle, linecolor = linecolor,linewidth=linewidth, markershape = markershape,markersize = markersize, legend=lengend, xlabel = xlabel, ylabel = ylabel,  dpi = 10, size = (width_px, height_px), title  = title, fontfamily = "Times Roman")

# ╔═╡ ef6b99db-e6b4-4bc5-8bbe-0c96f466f358
plot(1:5, st = :pie)

# ╔═╡ be7f630f-ba85-4bdc-a25b-faa191eb8af8
md"""
## 布局 Layouts
...
# ╔═╡ 9de012a9-f1a0-4186-b820-57ac7d5078f6
plot(rand(100, 5), layout = 5)

# ╔═╡ 1aa64cf0-0870-49d8-a7a4-bd83bd3299b0
plot(rand(100, 5), layout = [3,2])

# ╔═╡ 90fec136-ea07-4e73-9e54-0b10e1a557e7
begin
l = @layout [
    a{0.3w} [grid(3,3)
             b{0.2h}  ]
...
# ╔═╡ 8dd655d6-e07e-47e8-bd32-4003ec35516a
md"""
# 统计绘图
...
# ╔═╡ 15451901-93f3-4cde-bef0-2803b020ed94
begin
df1 = DataFrame(a = 1:10, b = 10 .* rand(10), c = 10 .* rand(10))
@df df1 plot(:a, [:b :c], colour = [:red :blue])
end

# ╔═╡ 8c1a44bd-ae45-4732-8788-0207471c90ed
md"""
一般来说， 不管绘制什么图形， 核心函数使用plot就可以了。不过， 在统计里面， 不同类型的图形有不同的含义， 用一个意义更明确地函数可能更直观。 因此， 建议学几个自己经常要用的图形函数是有帮助的。此外， 有些特别的统计图形， 无法用一个plot实现。
"""

# ╔═╡ ec61962c-15fb-4680-848c-5c589e0712cc
iris = CSV.read((joinpath(dirname(pathof(DataFrames)),
                                 "..", "docs", "src", "assets", "iris.csv")),
                       DataFrame)

# ╔═╡ 8a2f8d95-abcd-4d4e-af87-27c47b763a6c
md"""
## 散点图 scatter
"""

# ╔═╡ 766a4c5f-e52f-488d-ae68-e96cfe18f827
@df df1 scatter(:a, :b, markersize = 4 .* log.(:c .+ 0.1))

# ╔═╡ 1b80359f-684a-42ce-b132-dd7236ef2153
@df df1 plot(:a, :b, markersize = 4 .* log.(:c .+ 0.1), st=:scatter)

# ╔═╡ 0350df02-5b49-46ed-b677-607e9e66aa2b
@bind xx Select([:SepalLength,	:SepalWidth,	:PetalLength,	:PetalWidth	])

# ╔═╡ b1599278-f6e1-4de1-93e6-ac6794777a6e
@bind yy Select([:SepalLength,	:SepalWidth,	:PetalLength,	:PetalWidth	])

# ╔═╡ a584824e-dba4-40c4-a076-62aef9c7938d
@df iris scatter(:SepalLength, :SepalWidth)

# ╔═╡ 11320ed2-a9a1-433e-aae3-f048300976d5
iris

# ╔═╡ edc28366-6486-42f8-815b-3f776cb5062d
scatter(iris.SepalLength, iris.SepalWidth)

# ╔═╡ 3d1ff384-7923-4c81-89e8-8b8e5b375865
@df iris scatter(:SepalLength, :SepalWidth, group = :Species)

# ╔═╡ b2fac95b-f371-4ec9-98ad-9f3cbcd29347
md"""
## 密度图 density
一般用于画一个连续变量的概率密度曲线
"""

# ╔═╡ f9437c60-4e16-4014-b939-af9f620558b9
@bind n NumberField(100:10000, 500)

# ╔═╡ 1d1c0fda-d519-4a88-ad4a-d501175bc324
density(randn(n))

# ╔═╡ 947a288e-5936-4124-8df3-e56023dbecff
# 不同类别的密度图
@df iris density(:SepalLength,  group = :Species,  legend = :topright )

# ╔═╡ acb8e3ab-6b5f-4254-8a28-383441b987e6


# ╔═╡ 6992d236-082b-4123-92da-d41760e6d167
iris

# ╔═╡ 9efcd3ee-35dc-4a4b-9d44-8b1788ce2bd9
md"""
## 相关图corrplot 
有时候， 尤其是同时分析多个特征的时候， 我们希望把所有特征的相关图画出来， 用于对特征之间的关系做一个大致分析。
"""

# ╔═╡ c11e5b5b-0d76-4ff4-8b7d-a95f85e69672
gr(size = (600, 500))

# ╔═╡ 2c4a3218-73b0-4054-a788-5c28ff2ae00d
@df iris corrplot([:SepalLength :SepalWidth :PetalLength :PetalWidth])

# ╔═╡ 1f6ebde9-dac5-49c7-a307-83de6965a31b
md"""
## 箱线图 boxplot
箱线图一般也用来查看连续变量的分布情况。
"""

# ╔═╡ 2b84657a-af7c-4615-ba67-a2618427b88e
md"""
我们先将数据从宽格式转为长格式。
"""
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "d85da70f18826a6817340a5a180f1fd8496a505d"
